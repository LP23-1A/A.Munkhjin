 ...
 function Card(props) {
    return ( 
         <div className=" flex flex-col w-[392px] rounded-[12px] border-solid border-[#E8E8EA)] bg-[#FFF] border-[1px] gap-[16px] justify-center p-[16px]">
                    <img className="h-[240px] w-[360px] rounded-[6px]" src={props.img} />
                    <div>
                    <h2  className=" text-[#4B6BFB] px-[10px] py-[4px] flex justify-center  rounded-[6px] bg-[#4b6bfb0d] w-[97px] text-[14px]" >{props.tag}</h2>
